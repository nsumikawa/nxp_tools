...
if platform.node() == 'az84cqc01':
    sys.path.append('/home/nxa18331/git/excursion')
    sys.path.append('/home/nxa18331/git/excursion/django_config')
...
if platform.node() == 'az84cqc01':path = '/home/nxa18331/logs/web/excursion_detection'
